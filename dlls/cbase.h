...
#define	CLASS_CITIZEN_PASSIVE		14
#define CLASS_CITIZEN_MILITARY		15
...
#define CLASS_FACTION_A				21 //LRC - very simple new classes, for use with Behaves As
#define CLASS_FACTION_B				22
#define CLASS_FACTION_C				23
