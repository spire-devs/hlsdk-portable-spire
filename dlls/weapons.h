...
typedef	enum
{
	...
	BULLET_PLAYER_SMALLROUND,
	BULLET_PLAYER_MEDIUMROUND,
	BULLET_PLAYER_LARGEROUND,

	BULLET_MONSTER_9MM,
	BULLET_MONSTER_MP5,
	BULLET_MONSTER_12MM,
	BULLET_MONSTER_SMALLROUND,
	BULLET_MONSTER_MEDIUMROUND,
	BULLET_MONSTER_LARGEROUND,
} Bullet;
...
class CIceaxe : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
